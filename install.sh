...
sudo cp -v $ruta/root/p10k.zsh /root/.p10k.zsh
...
chmod +x ~/.config/bin/clear_history-sh
...
notify-send "autoBSPWM INSTALADO"

sleep 2

notify-send "CONFIGURACION by deeb"

sleep 3

notify-send "Selecciona BSPWM antes de iniciar sesión"
