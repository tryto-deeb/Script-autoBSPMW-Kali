...
() {
  ...
  typeset -g POWERLEVEL9K_BACKGROUND=23

  # Separator between same-color segments on the left.
  typeset -g POWERLEVEL9K_LEFT_SUBSEGMENT_SEPARATOR='%064F\uE0B1'
  # Separator between same-color segments on the right.
  typeset -g POWERLEVEL9K_RIGHT_SUBSEGMENT_SEPARATOR='%064F\uE0B3'
  ...
  typeset -g POWERLEVEL9K_PROMPT_CHAR_{OK,ERROR}_VIINS_CONTENT_EXPANSION='󰮯 '
  ...
  typeset -g POWERLEVEL9K_DIR_SHORTENED_FOREGROUND=65
